...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14__gurards_auth_guard__ = __webpack_require__("./src/app/gurards/auth.guard.ts");
var __decorate = (this && this.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_1__angular_core__["NgModule"])({
            ...
            imports: [
                ...
                __WEBPACK_IMPORTED_MODULE_10__angular_router__["b" /* RouterModule */].forRoot([
                    ...
                    },
                    {
                        ...
                        canActivate: [__WEBPACK_IMPORTED_MODULE_14__gurards_auth_guard__["a" /* AuthGuard */]]
                    },
                    {
                        path: 'profile',
            ...
            providers: [__WEBPACK_IMPORTED_MODULE_13__services_auth_service__["a" /* AuthService */], __WEBPACK_IMPORTED_MODULE_14__gurards_auth_guard__["a" /* AuthGuard */]],
...
module.exports = "<div class=\"form-container text-center\">\n    \n      <form #f=\"ngForm\" (ngSubmit)=\"onLoginSubmit()\" class=\"register\">\n        \n          <h1 class=\"h3 mb-5 font-weight-normal\">Login</h1>\n          <div ngModelGroup=\"contact\" #contact=\"ngModelGroup\">\n              \n              <div class=\"form-group\">\n                  <label for=\"inputEmail\">Email</label>\n                  <input type=\"email\" id=\"inputEmail\" name=\"email\" ngModel #email=\"ngModel\" class=\"form-control\" placeholder=\"Email address\" email required [(ngModel)]=\"emailVal\">\n                  \n                  <div class=\"alert alert-danger\" *ngIf=\"!email.valid && email.touched\">\n                      Email is required\n                  </div>\n              </div>\n    \n\n              <div class=\"form-group\">\n                  <label for=\"inputPassword\">Пароль</label>\n                  <input type=\"password\" id=\"inputPassword\" name=\"password\" ngModel #password=\"ngModel\" placeholder=\"Password\" pattern=\"^(?=.*[a-z])(?=.*[A-Z])(?=.*\\d)[a-zA-Z\\d]{4,}$\" class=\"form-control\" required [(ngModel)]=\"passwordVal\">\n                  \n                  <div class=\"alert alert-danger\" *ngIf=\"!password.valid && password.touched\">\n                      <div *ngIf=\"password.errors.required\">\n                          Password is required\n                      </div>\n                      <div *ngIf=\"password.errors.pattern\">\n                          Password should be minimum 4 characters, contain uppercase letter, lowercase letter, number\n                      </div>\n                  </div>\n                    \n              </div>\n          </div>\n                  \n          <button type=\"submit\" class=\"btn btn-primary\" [disabled]=\"!f.valid\">Submit</button>\n        </form>\n    \n      </div>\n      "
...
var RegisterComponent = /** @class */ (function () {
    function RegisterComponent(authService, router, _flashMessagesService) {
        this.authService = authService;
        this.router = router;
        this._flashMessagesService = _flashMessagesService;
    }
